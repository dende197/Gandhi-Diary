...
const configuredTtlMs = Number(process.env.SESSION_VAULT_TTL_MS);
const TTL_MS = Number.isFinite(configuredTtlMs) && configuredTtlMs > 0 ? configuredTtlMs : DEFAULT_TTL_MS;
const vault = new Map();
