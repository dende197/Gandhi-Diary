    ...
    try {
        ...
        for (const blocco of datiList) {
            ...
            for (const a of assenzeRaw) {
                ...
                // giustificata: "S" means "Sì" (Yes) in DidUp
                const giustificata = !!(a.flgDaGiustificare === false || a.giustificata === 'S' || a.giustificata === true || a.datGiustificazione || a.flgGiustificata);
                // daGiustificare: if it's not justified yet
                const daGiust = !giustificata;
            ...
            for (const n of noteRaw) {
                // Try ALL possible text fields from DidUp — desDescrizione is confirmed from logs
