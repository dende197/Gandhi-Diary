...
const APP_SHELL = [
  ...
  `${BASE_PATH}/style.css?v=3.9.7`,
  `${BASE_PATH}/animations.css?v=3.9.7`,
  `${BASE_PATH}/ui.js?v=3.9.7`,
  `${BASE_PATH}/app-bootstrap.js?v=3.9.7`,
  `${BASE_PATH}/fluidity-engine-v3.js?v=3.9.7`,
  `${BASE_PATH}/fluidity-boot-patch.js?v=3.9.7`,
