...
const APP_SHELL = [
  ...
  `${BASE_PATH}/style.css?v=4.0.2`,
  `${BASE_PATH}/animations.css?v=4.0.2`,
  `${BASE_PATH}/ui.js?v=4.0.2`,
  `${BASE_PATH}/app-bootstrap.js?v=4.0.2`,
  `${BASE_PATH}/fluidity-engine-v3.js?v=4.0.2`,
  `${BASE_PATH}/fluidity-boot-patch.js?v=4.0.2`,
